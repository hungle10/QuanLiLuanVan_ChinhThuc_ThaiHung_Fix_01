...
namespace QuanLiLuanVan_ChinhThuc
{
    public class DataProvider
    {
       ...
       // private string connectionStr = @"Data Source=LEHUNG\THAIHUNG;Initial Catalog=WindowFix_01;Integrated Security=True;Encrypt=False";
        ...
        public DataTable GetTableWithKey(string tableName,string nameKey,string key)
        {
            string query = string.Format("Select * from {0} where {1} like '%{2}%'",tableName,nameKey,key);
